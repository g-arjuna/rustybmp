...
VALUES
  (1001, CAST(NOW() AS TIMESTAMP) - INTERVAL '5 minutes',  'origin_change',    '203.0.113.0/24', '10.0.0.1', 0.97,
   'Origin ASN changed from 64496 to 64512', 'critical'),
  (1002, CAST(NOW() AS TIMESTAMP) - INTERVAL '12 minutes', 'route_leak',       '192.0.2.0/24',   '10.0.0.2', 0.88,
   'Private prefix propagated to transit peer', 'critical'),
  (1003, CAST(NOW() AS TIMESTAMP) - INTERVAL '3 minutes',  'slow_convergence', '8.8.8.0/24',     '10.0.0.3', 0.61,
