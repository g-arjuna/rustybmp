...
VALUES
  (NOW(), '10.0.0.100', '10.0.0.1', 65001, 'ipv4-unicast', 750000, 80),
  (NOW(), '10.0.0.100', '10.0.0.2', 65002, 'ipv4-unicast', 500000, 80),  -- peer at 99.6% — near limit
  (NOW(), '10.0.0.200', '10.0.0.3', 65003, 'ipv4-unicast', 200000, 90),
  (NOW(), '10.0.0.200', '10.0.0.4', 65004, 'ipv6-unicast', 100000, 80)
